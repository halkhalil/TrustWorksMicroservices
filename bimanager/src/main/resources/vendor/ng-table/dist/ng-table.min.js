    ...
    return function () {
        ...
        var h = function (a) {
            ...
            this.data = [], this.parameters = function (b, c) {
                ...
                return a.isDefined(b) ? this.parameters({page: b}) : r.page
            }, this.total = function (b) {
                return a.isDefined(b) ? this.settings({total: b}) : s.total
            }, this.count = function (b) {
                return a.isDefined(b) ? this.parameters({count: b, page: 1}) : r.count
                ...
                return a.isDefined(b) ? this.parameters({sorting: b}) : r.sorting
