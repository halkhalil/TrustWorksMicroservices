    ...
    (function (grid) {
        ...
        var ColumnApi = (function () {
            ...
            ColumnApi.prototype.hideColumns = function (colIds, hide) {
                this._columnController.hideColumns(colIds, hide);
            };
            ColumnApi.prototype.columnGroupOpened = function (group, newValue) {
                this._columnController.columnGroupOpened(group, newValue);
            };
            ColumnApi.prototype.getColumnGroup = function (name) {
                return this._columnController.getColumnGroup(name);
            };
            ...
            ColumnApi.prototype.setState = function (columnState) {
                return this._columnController.setState(columnState);
            };
            ...
            ColumnApi.prototype.getVisibleColAfter = function (col) {
                return this._columnController.getVisibleColAfter(col);
            };
            ColumnApi.prototype.getVisibleColBefore = function (col) {
                return this._columnController.getVisibleColBefore(col);
            };
            ColumnApi.prototype.setColumnVisible = function (column, visible) {
                this._columnController.setColumnVisible(column, visible);
            };
            ...
            ColumnApi.prototype.moveColumn = function (fromIndex, toIndex) {
                this._columnController.moveColumn(fromIndex, toIndex);
            };
            ColumnApi.prototype.movePivotColumn = function (fromIndex, toIndex) {
                this._columnController.movePivotColumn(fromIndex, toIndex);
            };
        ...
        var RowRenderer = (function () {
            ...
            RowRenderer.prototype.focusCell = function (eCell, rowIndex, colIndex, colDef, forceBrowserFocus) {
                ...
                this.focusedCell = {
                    rowIndex: rowIndex,
                    colIndex: colIndex,
                    node: this.rowModel.getVirtualRow(rowIndex),
                    colDef: colDef
                };
