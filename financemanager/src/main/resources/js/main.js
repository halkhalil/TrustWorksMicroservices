...
var rootURL = "http://localhost:9098/expenses";
...
function renderList(data) {
    ...
    $.each(list, function(index, wine) {
        $('#wineList').append('<li><a href="#" data-identity="' + wine.uuid + '">'+wine.description+'</a></li>');
    });
}

function renderDetails(wine) {
    $('#wineId').val(wine.uuid);
    $('#description').val(wine.description);
    $('#type').val(wine.type);
    $('#month').val(wine.month);
    $('#year').val(wine.year);
    $('#expense').val(wine.expense);
