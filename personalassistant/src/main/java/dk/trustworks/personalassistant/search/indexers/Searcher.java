...
public class Searcher {
    ...
    public List<IndexItem> findByTitle(String queryString, int numOfResults) throws ParseException, IOException {
        ...
        for (ScoreDoc scoreDoc : queryResults) {
            ...
            results.add(new IndexItem(Long.parseLong(doc.get(IndexItem.ID)), doc.get(IndexItem.TITLE), "", doc.get(IndexItem.PATH)));
        }
     ...
     * @throws NumberFormatException 
      */
    public List<IndexItem> findByContent(String queryString, int numOfResults) throws NumberFormatException, Exception {
        // create query from the incoming query string.
        ...
        for (ScoreDoc scoreDoc : queryResults) {
            Document doc = searcher.doc(scoreDoc.doc);
            results.add(new IndexItem(Long.parseLong(doc.get(IndexItem.ID)), doc.get(IndexItem.TITLE), LuceneHighlighter.highlight(doc.get(IndexItem
                    .CONTENT), queryString), doc.get(IndexItem.PATH)));
        }
