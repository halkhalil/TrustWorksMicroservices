...
public class Mother extends Topic {
    ...
    private void postDirective() {
        ...
        SlackMessage slackMessage = new SlackMessage("Priority one Insure return of organism for analysis. " +
                "All other considerations secondary. Crew expendable.", "in_channel");
        try {
            Unirest.post(recipient)   //"https://slack.com/api/chat.postMessage")
    ...
    private void postWhoMotherIs() {
        ...
        try {
            SlackMessage slackMessage = new SlackMessage("My name is actually MU-TH-UR 6000. " +
                    ...
                    "Now I aim to serve TrustWorkers!", "in_channel");
    ...
    private void postWhatMotherIs() {
        ...
        try {
            SlackMessage slackMessage = new SlackMessage("I am a MU-TH-UR 6000, 182 model 2.1 terabyte AI Mainframe that " +
                    "served as the computer mainframe for the Nostromo. Now I aim to serve TrustWorkers!", "in_channel");
